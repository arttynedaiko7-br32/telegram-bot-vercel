...
Я — ваш помощник для анализа данных и документов.

📊 Работаю с Google Таблицами  
📄 Анализирую PDF-файлы  
💬 Отвечаю на вопросы по содержимому  

📌 Команды:
/help — справка
/table — анализ Google Sheets
/reset — сброс состояния
/clear — очистка истории

Задавай вопросы, присылай данные или загружай PDF — я постараюсь помочь!`
...
bot.command("help", (ctx) => {
  ...
  ctx.reply(
    "📌 Доступные команды:\n" +
    "/start — запуск бота\n" +
    "/table — анализ Google Sheets по ссылке\n" +
    "/table_exit — выйти из режима таблицы\n" +
    "Режим работы с PDF файлами\n" +
    "📄 Загрузите PDF, затем задавайте вопросы по его содержимому\n" +
    "📄 Поддерживается анализ текста, таблиц и структуры документа\n" +
...
if (
  session.mode === SessionMode.TEXT &&
  (session.spreadsheetId || session.sheetUrl)
) {
  session.spreadsheetId = null;
  session.sheetUrl = null;
  session.messages = [];
